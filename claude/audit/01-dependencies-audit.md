...
- **vue** (3.2.38 → 3.5.24) - _Actually needs update_
- **vue-router** (4.1.5 → 4.6.3) - _Actually needs update_
- **gsap** (3.11.3 → 3.13.0) - _Actually needs update_
- **lottie-web** (5.9.6 → 5.13.0) - _Actually needs update_
- **file-saver** (2.0.5) ✓
