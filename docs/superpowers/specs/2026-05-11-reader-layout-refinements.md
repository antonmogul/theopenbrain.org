...
- New quiz/flashcard/lab content — only their _display placement_ inside the reader.
...
2. **Sticky figure offset.** Scroll the reader — figure pane should sit _below_ the top bar at all scroll positions, never overlapping.
