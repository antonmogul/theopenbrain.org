...
state layers, highlight overlays, and switch *variant labels* are absent — the figures
...
- CODE fixes touch the shared transformer but only *recover* previously-dropped
