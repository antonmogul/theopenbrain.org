...
> publishable key (from `.env`) and the *exact* REST queries `useChapter.fetchChapter`
...
{ "id":"animationEyeStructur", "title":"Eye structure",
  "highlight":true, "fullscreen":false, "clickTriggered":true }
