...
INSERT INTO animations (id, animation_key, title, description, media_type, interaction_type, scientific_domain, load_priority, file_size_bytes, created_at, updated_at)
VALUES
  -- Lottie Animations
  (
