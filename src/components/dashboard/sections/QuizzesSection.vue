...
const showQuestionEditor = defineModel("showQuestionEditor", {
  type: Boolean,
  default: false,
});
const questionForm = defineModel("questionForm", {
  type: Object,
  required: true,
});
  ...
  <section class="section">
    ...
    <BaseCard v-else-if="showQuizEditor" padding="lg">
      <div class="card-head">
        ...
        <Button variant="ghost" size="sm" @click="$emit('close-quiz')"
      ...
      <div class="form-stack">
        ...
        <div class="form-actions">
          <Button variant="ghost" size="sm" @click="$emit('close-quiz')"
            >Cancel</Button
          >
          <Button variant="solid" size="sm" @click="$emit('save-quiz')">{{
      ...
      <div v-if="editingQuiz" class="questions-section">
        <div class="card-head">
          ...
          <Button variant="outline" size="sm" @click="$emit('open-question')"
            >+ Add question</Button
          >
        </div>
      ...
      >
        ...
        <template #footer>
          <Button variant="ghost" size="sm" @click="$emit('close-question')"
            >Cancel</Button
          >
          <Button variant="solid" size="sm" @click="$emit('save-question')">{{
