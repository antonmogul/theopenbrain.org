...
const { signUp, signIn, signOut, resetPassword, isAuthenticated, user } = useAuth();
        ...
        <div class="font-sans">
          ...
          <section v-if="isAuthenticated" class="pb-8">
            <p class="text-base pb-6">
              Logged in as: <span class="text-violet">{{ user?.email }}</span>
            </p>
            <button
              @click="handleLogout"
          ...
          <!-- Register Form -->
          <section v-else-if="authStore.authView === 'register'" class="pb-8">
            <form @submit.prevent="handleRegister" class="flex flex-col gap-6">
              ...
              <div class="flex flex-col gap-2">
                <label class="text-small uppercase font-mono text-light">Confirm Password</label>
                <input
          ...
          <!-- Login Form -->
          <section v-else-if="authStore.authView === 'login'" class="pb-8">
          ...
          <section v-else-if="authStore.authView === 'forgot'" class="pb-8">
