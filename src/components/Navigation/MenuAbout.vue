        ...
        >
            <div class="px-24 pt-12 pb-56 w-[50vw] max-w-[800px]">
                <div class="font-sans">
                    ...
                    <section class="pb-56">
                        <h3>
                            <em>The Open Brain</em> is an Open Access
                            neuroscience textbook.
                        </h3>
                        <p class="pb-42 text-base">
                            While we currently only have one chapter online, we
                            are actively seeking funding in order to expand the
                            book with many more chapters covering the breadth of
                            neuroscience topics. Stay tuned for more!
                        </p>
                    </section>
                    <section>
                    ...
                    <section>
                        ...
                        <span>
                            ...
                            <p>
                                Chapter authors: Arjun Krishnaswamy, Stuart
                                Trenholm
                            </p>
