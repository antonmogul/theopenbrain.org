      ...
      <div class="grid grid-cols-12 gap-8">
        ...
        <aside class="col-span-4 lg:col-span-3">
          <div class="sticky top-24">
            <h2 class="text-lg font-semibold mb-4">Content Blocks</h2>
            ...
            <div v-else class="space-y-2 max-h-[70vh] overflow-y-auto pr-2">
              ...
              >
                ...
                <div class="text-xs text-light mt-1">
                  {{ paragraph.sections?.modules?.title || "Unknown Module" }}
                </div>
              </button>
            </div>
          </div>
        ...
        <div class="col-span-8 lg:col-span-9">
          <div v-if="!selectedParagraph" class="text-center py-20 text-light">
            <p class="text-xl mb-4">Select a content block to edit</p>
            ...
            <div class="mt-6 p-4 bg-white/5 rounded-lg">
              ...
              <div class="grid grid-cols-2 gap-4 text-sm text-light">
                <div>
                  ...
                  {{ selectedParagraph.sections?.title || "Unknown" }}
                </div>
                <div>
                  <span class="text-white">Module:</span>
                  {{ selectedParagraph.sections?.modules?.title || "Unknown" }}
                </div>
                <div>
