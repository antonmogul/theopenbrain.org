/*
 * Center surround receptive fields: a switch figure (see ../switch/SwitchFigure.vue), matched to
...
export default {
  id: "center-surround",
  name: "Center surround receptive fields",
  animationKey: "animationCenterSurroundReceptiveFields",
  ...
  defaults: {
    title: "Center surround receptive fields",
    switches: ["Center", "Center + surround"],
    legend: [
      "Photoreceptors",
      "Horizontal cells",
      "Bipolar cells",
