/*
 * Rod vs. cone circuits: a switch figure (see ../switch/SwitchFigure.vue), matched to
...
export default {
  id: "rod-cone",
  name: "Rod vs. cone circuits",
  animationKey: "animationRodVsConeCircuits",
